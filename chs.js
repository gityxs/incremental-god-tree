...
var cnItems = {
    ...
    "Tree softcap starts +15 later.": "树软上限在 +15 后开始。",
    ...
    "Reset for crypto": "重置以获得密码",
    "Boosts leaf generation based on crypto.": "基于密码提升叶子生成。",
    "Boosts point generation based on crypto.": "基于密码提升点数生成。",
    "Boosts tree generation based on crypto.": "基于密码提升树生成。",
    "Engineering": "工程",
    "Softcap starts later based on crypto.": "软上限 稍后基于 密码 启动。",
    "Tree softcap starts 1.5x later.": "树的软上限在 1.5x 之后开始。",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Get (.+) mods.$/, '获得 $1 模块。'],
    [/^Get (.+) 1st crypto dimensions.$/, '获得 $1 第1密码维度。'],
    ...
    [/^You have ([\d\.]+)$/, '你有 $1'],
    [/^You will gain ([\d\.]+)$/, '你将获得 $1'],
    [/^You beat ([\d\.]+)$/, '你击败了 $1'],
    [/^You are making ([\d\.]+)$/, '你制造了 $1'],
    [/^([\d\.]+) elves$/, '$1 精灵'],
