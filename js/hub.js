            ...
            "Main": {
                ...
                content:
                    [
                        ...
                        ["raw-html", function () { return "G1: " + format(player.h.slotgreenenergy[1], 0) + " G2: " + format(player.h.slotgreenenergy[2], 0) + " G3: " + format(player.h.slotredenergy[3], 0) + " G4: " + format(player.h.slotgreenenergy[4], 0) + " G5: " + format(player.h.slotredenergy[5], 0) + " G6: " + format(player.h.slotgreenenergy[6], 0) + " G7: " + format(player.h.slotgreenenergy[7], 0) }, { "color": "green", "font-size": "18px", "font-family": "monospace" }],
